...
public class Ass7 
{
  ...
  public static void CreateTasks()
  {
	  try 
	  {
		oPage.getAddNewTasks().click();
		Thread.sleep(2000);
		oPage.getCreateNewTasks().click();
		Thread.sleep(2000);
		oPage.getTaskTextField().sendKeys("rocky");
		Thread.sleep(2000);
		oPage.getClickonCreateTaskButton().click();
		Thread.sleep(2000);
		/*oPage.getCloseButtonWindow().click();
		Thread.sleep(2000);*/
	  }catch (Exception e)
	  {
		e.printStackTrace();
  ...
  public static void DeleteTasks()
  {
	  try 
	  {
		  oPage.getClickOnCreatedUserAction1().click();
		  Thread.sleep(2000);
		  oPage.getActionButtonForUser1().click();
		  Thread.sleep(2000);
		  oPage.getDeleteButtonForTask1().click();
		  Thread.sleep(2000);
		  oPage.getDeletePermanentlyButtonForTask().click();
		  Thread.sleep(2000);
	  }
	  catch (Exception e) 
	  {
