...
public class D_actiassi4 
{
	...
	public static void modifycustomer()
	{
		try 
		{
			...
			Thread.sleep(2000);
			c1.findElement(By.xpath("//textarea[@placeholder='Enter customer description...']")).sendKeys("raveendra");
			Thread.sleep(2000);
			c1.findElement(By.xpath("//*[@id=\"taskListBlock\"]/div[2]/div[1]/div[1]")).click();
			Thread.sleep(2000);
		}
		catch (Exception e) 
		{
